...
FEEDBACK_CONFIG = {
    ...
    # Время для отправки вечерних напоминаний (час и минута, 24ч)
    "send_hour": 20,
    "send_minute": 0
}
...
# config.py - убедитесь, что есть эти настройки
REMINDER_CONFIG = {
    "reminder_day": 3,           # 0=понедельник, 1=вторник, ..., 6=воскресенье (3=четверг)
    "reminder_hour": 18,         # Час отправки (18:00)
    "reminder_minute": 0,        # Минута отправки
    "enable_teacher_reminders": True,
    "enable_student_reminders": True,
    "reminder_message": "Привет, {name}! 👋\n\nНАПОМИНАНИЕ! Проставьте свои возможности на следующую неделю 📅\n\nЕсли вы уже свободны для занятий, используйте кнопку '📅 Забронировать время' в меню!"
}

# Интервал проверки отзывов для обоих типов пользователей
FEEDBACK_CHECK_INTERVAL = 600  # 30 минут в секундах
